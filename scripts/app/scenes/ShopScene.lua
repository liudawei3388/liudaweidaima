...
function ShopScene:ctor()
    ...
    --下一关按钮
    local nextLV_btn = cc.ui.UIPushButton.new({normal = "button/shopArrow.png"}, {scale9 = true})
    ...
    --向左按钮
    local left_btn = cc.ui.UIPushButton.new({normal = "button/buyleftbtn.png"}, {scale9 = true})
    ...
    --购买按钮
    local buy_btn = cc.ui.UIPushButton.new({normal = "button/buypowerbtn.png"}, {scale9 = true})
    ...
    --向右按钮
    local right_btn = cc.ui.UIPushButton.new({normal = "button/buyrightbtn.png"}, {scale9 = true})
